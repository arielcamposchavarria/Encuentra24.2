      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-5">
            ...
            <a
              href="#"
              className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center hover:-translate-y-1 hover:shadow-lg hover:shadow-[#25D366]/50 transition-all duration-300"
              title="WhatsApp"
            >
            ...
            {/* Instagram */}
            <a
              href="https://www.instagram.com/cccbrcr/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#dc2743] rounded-full flex items-center justify-center hover:-translate-y-1 hover:shadow-lg hover:shadow-[#e6683c]/50 transition-all duration-300"
              title="Instagram"
            >
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="#"
              className="w-10 h-10 bg-[#1877F2] rounded-full flex items-center justify-center hover:-translate-y-1 hover:shadow-lg hover:shadow-[#1877F2]/50 transition-all duration-300"
              title="Facebook"
            >
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="#"
              className="w-10 h-10 bg-[#EA4335] rounded-full flex items-center justify-center hover:-translate-y-1 hover:shadow-lg hover:shadow-[#EA4335]/50 transition-all duration-300"
              title="Gmail"
            >
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
