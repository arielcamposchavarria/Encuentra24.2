  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 sticky top-4">
      ...
      <div className="space-y-3 mb-6">
        <button className="w-full bg-[#202d59] hover:bg-[#202d59]/90 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2">
        ...
        <button className="w-full bg-[#00cfe5] hover:bg-[#00cfe5]/90 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2">
        ...
        <button className="w-full border-2 border-[#202d59] text-[#202d59] hover:bg-[#00cfe5]/10 font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
